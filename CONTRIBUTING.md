...
- Read `README.md` and `docs/REPOSITORY_OVERVIEW.md` to confirm that the work belongs in Sakurai.
- Follow the repository-wide conventions in `docs/REPOSITORY_STRUCTURE.md` and `docs/PROJECT_STANDARDS.md`.
- Identify the exact generation, game, release, revision, dump, project, comparison, reference, or target when applicable.
- Check `docs/RESEARCH_GUIDE.md` and `docs/VERIFICATION.md` before promoting a claim.
...
- Repository-wide docs belong in `docs/`; reusable manifests belong in `manifests/`.
...
1. what changed;
2. which target or coordinate it affects;
3. what evidence supports the change;
4. how it was verified;
5. any remaining uncertainty or limitations.

See `docs/README.md`, `docs/WORKFLOW.md`, `docs/PAIRING.md`, and `manifests/README.md` for the repository-wide workflow.
