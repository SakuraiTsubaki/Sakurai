# Pokémon Black / White EUR — Semantic Census Phase 2
...
- Named/role-bearing archives with confirmed/high/probable identification: **31**
- Remaining archives retain structural categories rather than invented names.
- Classification policy: exact role names are only assigned where supported by local binary structure and/or published Gen V research; otherwise the row remains structural.
...
| `/a/0/0/8` | Map resources | confirmed | 649 | 480 / 25632 / 99520 B |
| `/a/0/1/1` | Battle background/UI 2D+3D resources | high | 222 | 103 / 2248.0 / 100084 B |
| `/a/0/1/2` | ZoneData / map association table | high | 1 | 20496 / 20496 / 20496 B |
...
| `/a/0/2/4` | Item parameter data | high | 627 | 36 / 36 / 36 B |
| `/a/0/2/6` | Title-screen resources | high | 15 | 112 / 552 / 13882 B |
| `/a/0/5/6` | Field/event scripts | confirmed | 44 | 131 / 436.0 / 32832 B |
...
| `/a/0/7/1` | Trainer front/VS sprite resources | high | 39 | 142 / 362 / 28864 B |
| `/a/0/7/2` | Trainer back/send-out sprite resources | high | 760 | 60 / 99.0 / 2160 B |
...
| `/a/2/0/5` | Starter-selection scene 2D resources | probable | 40 | 99 / 552.0 / 98388 B |
...
Only five ordinary NARCs differ between the Black and White ROMs: `a/0/2/6`, `a/0/8/6`, `a/1/2/6`, `a/1/7/8`, and `a/2/3/1`. Across their contents, 66 member pairs differ. ARM9 overlays have 180 true decompressed differences.

## Rule for future phases
Unknown/custom archives are not force-labeled. Next phases should resolve them by ARM9/overlay xrefs, script consumers, file-index tables, and render/decode tests, then promote confidence in this ledger.
