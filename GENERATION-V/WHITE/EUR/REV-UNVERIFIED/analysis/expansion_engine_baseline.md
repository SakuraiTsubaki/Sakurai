# Generation V — Pokémon White Expansion Engine Baseline

## Scope

This document records the current baseline for expanding Pokémon White Version (EUR) on the Generation V engine.
...
Pokémon Black Version (EUR) is tracked separately under its own GAME hierarchy and may be used for paired-version comparison.
...
- Exact revision of the uploaded EUR Pokémon White ROM.
