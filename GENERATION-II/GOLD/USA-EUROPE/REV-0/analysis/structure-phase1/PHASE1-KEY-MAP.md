# Phase 1 Key Map — USA-EUROPE-REV-0

# Structural Survey Phase 1 — USA-EUROPE-REV-0

- Source: `Pokemon - Gold Version (USA, Europe).gbc` (external/read-only; not part of generated corpus)
...
- Long `00`/`FF` runs (>=32 bytes): 178
- Pointer-table candidates (heuristic): 1,000
- Immediate-address opcode candidates: 1,401
...
DEF ROM_TITLE EQUS "POKEMON_GLDAAUE"
DEF CGB_FLAG EQU $80
...
DEF HEADER_CHECKSUM EQU $4B
DEF GLOBAL_CHECKSUM EQU $682D
```
