# Phase 1 Key Map — JP-REV-0

# Structural Survey Phase 1 — JP-REV-0

- Source: `Pocket Monsters Kin (Japan).gbc` (external/read-only; not part of generated corpus)
...
DEF HEADER_CHECKSUM EQU $48
DEF GLOBAL_CHECKSUM EQU $8A70
```
