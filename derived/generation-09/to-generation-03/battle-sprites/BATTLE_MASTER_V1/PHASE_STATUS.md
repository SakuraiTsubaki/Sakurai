...
## Phase 2 — complete Pokémon logical-role census

Status: **STARTED — SCHEMA FIXED, FULL ROW POPULATION PENDING PUBLIC EVIDENCE ENUMERATION**

The role census is keyed by game/version/species/form/gender/shiny/source role and must preserve:
