# Pokémon Diamond (USA) Rev-5 — original ROM expansion limits
...
| Area | Diamond original | Expansion implication |
|---|---|---|
...
The Diamond ROM currently has roughly 5.66 MiB of unused tail space. ROM capacity is not the first architectural wall; fixed/packed data formats fail first. Full modern sprites/forms will eventually require FAT/ROM growth.
