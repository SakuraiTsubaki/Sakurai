# Pokémon HeartGold (KR) Rev-0 — original ROM expansion limits
...
| Area | HeartGold original | Expansion implication |
|---|---|---|
...
The HeartGold ROM currently has roughly 9.13 MiB of unused tail space. Fixed/packed data formats fail before raw ROM capacity, but a full modern sprite/form set will require ROM/FAT growth.
